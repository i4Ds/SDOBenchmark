...
mr = ModelRunner('simple_cnn_model_one_slice_threshold')  # cuda_visible_devices="", log_device_placement=False

bin_count = 10
main_input = mr.init_input(augment_data=False, sample_data_only=True, only_last_slice=True, label_funcs=get_label_funcs_threshold(bin_count))
...
layers = Conv2D(8, (5, 5), strides=(2, 2), activation="relu")(main_input)
