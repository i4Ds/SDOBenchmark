...
from model_utils.model_runner import ModelRunner, LABEL_FUNCS_LOGEXP
from keras.layers import Dense, Flatten, TimeDistributed, Conv2D, Activation, MaxPooling2D

mr = ModelRunner('simple_cnn_model_logexp')  # , cuda_visible_devices="2", log_device_placement=False)

main_input = mr.init_input(augment_data=False, sample_data_only=False,
                           label_funcs=LABEL_FUNCS_LOGEXP)
...
mr.train(layers, optimizer=Adam(), epochs=100, batch_size=1) #, no_train=True
